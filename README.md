...
- **DevOps Job Portal (Azure)** — deployed full-stack app on Azure (App Service + Azure SQL) + CI/CD workflows  
  → https://github.com/beamartin27/DevOps-job-portal
- **TinyLink** — URL shortener with FastAPI + SQLite + UI + REST API  
  → https://github.com/beamartin27/tinylink
- **Gym_Project** — Full java app with backend + frontend
  → https://github.com/beamartin27/Gym_Project

### 🌍 Portfolio
- Website: https://beamartin27.github.io  
- LinkedIn: https://www.linkedin.com/in/beamartin27

### 📫 Contact
Open to internships from Feb 2026. Feel free to reach out via LinkedIn.
